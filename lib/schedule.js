...
// Route-Enum ist 4-wertig und identisch zum bestehenden vacuum.cleaning-route-Enum
// (Nachtrag nach Runde 4: Werte 2/3 in der Live-Analyse nicht gemessen, aber
// App-seitig anwaehlbar bei Terminen mit Wisch-Modus; Rohwert 4 = "quick", nicht "fast").
const ALL_ROOMS_ROUTE = Object.freeze({ 1: 'standard', 2: 'intensive', 3: 'deep', 4: 'quick' });
 ...
 *   Bits 0-3   route (Enum, 4 Werte 1=standard/2=intensive/3=deep/4=quick,
 *              identisch zum bestehenden vacuum.cleaning-route-Enum)
