...
module.exports = [
  ...
  // SIID 4 / PIID 6:
  //   labelled "water-tank" in the generic spec, but r6001*
  //   has no separate onboard water tank — mop pads are
  //   the removable water-system unit. Isolated manual mop
  //   test in issuecomment-5492429062 confirms PIID 6
  //   tracks pad presence 1:1 (0 = not mounted, 1 = mounted).
  //   Remapped here to reflect its actual meaning on this
  //   family.
  {
    kind: 'remap',
    siid: 4,
