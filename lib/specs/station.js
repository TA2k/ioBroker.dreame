  ...
  statusStates: [
    {
      ...
      deriveStates: [
        { id: 'clean-water-tank-installed', nameKey: 'vacuum.status.clean-water-tank-installed', type: 'boolean', role: 'indicator', compute: (v) => v !== 1 },
        { id: 'clean-water-tank-low',       nameKey: 'vacuum.status.clean-water-tank-low',       type: 'boolean', role: 'indicator', compute: (v) => v === 2 },
      ],
    },
    {
