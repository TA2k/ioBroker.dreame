...
module.exports = {
  statusStates: [
    ...
    // SIID 20 — Detergent
    { id: 'detergent-left',      siid: 20, piid: 1, nameKey: 'vacuum.status.detergent-left',      type: 'number', role: 'value', unit: '%' },
    { id: 'detergent-time-left', siid: 20, piid: 2, nameKey: 'vacuum.status.detergent-time-left', type: 'number', role: 'value', unit: 'h' },
    // SIID 26 — Dirty Water Tank
