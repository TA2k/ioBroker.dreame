...
const CLEANING_MODE_DECODE = (raw) => raw & 3;
const CLEANING_MODE_ENCODE = (newMode, raw) => ((raw & ~3) | (newMode & 3)) >>> 0;
...
module.exports = {
  ...
  remoteStates: [
    ...
    },
    {
      ...
      type: 'number',
      role: 'level',
      stateKeys: { 0: 'vacuum.cleaning-mode.sweeping', 1: 'vacuum.cleaning-mode.mopping', 2: 'vacuum.cleaning-mode.sweep-mop', 3: 'vacuum.cleaning-mode.mop-after-sweep' },
